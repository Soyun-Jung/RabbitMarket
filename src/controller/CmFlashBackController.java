...
/**
 * Servlet implementation class CmFlashBackController
 */
@WebServlet("/CmFlashBackController")
public class CmFlashBackController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CmFlashBackController() {
        super();
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(bfserv.CommentFlachBack(cmi)) {
